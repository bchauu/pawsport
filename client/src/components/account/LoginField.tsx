...
const LoginField = () => {
    ...
    const handleLogin = async() => {
        try {
            ...
            if (error.response) {
                ...
                Alert.alert('Login Failed', 'No response from server. Please check your network connection.');
              } else {
    ...
    return (
        <View>
            <TextInput placeholder="Email" value={cred.email} onChangeText={value => handleChange("email", value)}></TextInput>
            <TextInput placeholder="Password" value={cred.password} onChangeText={value => handleChange("password", value)}></TextInput>
